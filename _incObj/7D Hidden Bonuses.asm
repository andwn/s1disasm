...
.equ bonus_timelen, 0x30		/* length of time to display bonus sprites */
# ===========================================================================
...
Bonus_Main:	/* Routine 0 */
		...
		add.w	d0,d0
		move.w	bonusArr(pc,d0.w),d0 /* load bonus points array */
		jsr	(AddPoints).l
...
# ===========================================================================
bonusArr:	dc.w 0			/* Bonus	points array */
		dc.w 1000
		dc.w 100
		dc.w 1
# ===========================================================================
...
Bonus_Display:	/* Routine 2 */
		...
		out_of_range_s	Bonus_Display_Delete
		jmp	(DisplaySprite).l
