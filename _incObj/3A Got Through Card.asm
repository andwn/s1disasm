...
.equ got_mainX, 0x30		/* position for card to display on */
.equ got_finalX, 0x32		/* position for card to finish on */
# ===========================================================================
...
Got_Move2:	/* Routine $E */
		moveq	#0x20,d1		/* set horizontal speed */
...
Got_Config:	dc.w 4,		0x124,	0xBC			/* "SONIC HAS" */
		dc.b 				2,	0

		dc.w -0x120,	0x120,	0xD0			/* "PASSED" */
		dc.b 				2,	1

		dc.w 0x40C,	0x14C,	0xD6			/* "ACT" 1/2/3 */
		dc.b 				2,	6

		dc.w 0x520,	0x120,	0xEC			/* score */
		dc.b 				2,	2

		dc.w 0x540,	0x120,	0xFC			/* time bonus */
		dc.b 				2,	3

		dc.w 0x560,	0x120,	0x10C			/* ring bonus */
		dc.b 				2,	4

		dc.w 0x20C,	0x14C,	0xCC			/* oval */
		dc.b 				2,	5
