...
SolidObject:
		...
		sub.w	obX(a0),d0
		add.w	d1,d0
		bmi.s	1f		/* if Sonic moves off the left, branch */
...
Solid_TopBottom:
		...
		cmpi.w	#0x10,d3		/* has Sonic landed on the object? */
...
Solid_ResetFloor:
		...
		moveq	#0,d0
		move.b	0x3D(a1),d0	/* get object being stood on */
		lsl.w	#6,d0
	...
	1:
		...
		lsr.w	#6,d0
		andi.w	#0x7F,d0
		move.b	d0,0x3D(a1)	/* set object being stood on */
