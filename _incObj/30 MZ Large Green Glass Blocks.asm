...
.equ glass_dist, 0x32		/* distance block moves when switch is pressed */
.equ glass_parent, 0x3C		/* address of parent object */
...
2:
		...
		move.w	#0xC38E,obGfx(a1)
		move.b	#4,obRender(a1)
		move.w	obY(a1),0x30(a1)
		move.b	obSubtype(a0),obSubtype(a1)
		move.b	#0x20,obActWid(a1)
		move.b	#4,obPriority(a1)
		move.b	(a2)+,obFrame(a1)
		move.l	a0,glass_parent(a1)
		dbf d1,3b	/* repeat once to load "reflection object" */

		move.b	#0x10,obActWid(a1)
		move.b	#3,obPriority(a1)
		addq.b	#8,obSubtype(a1)
		andi.b	#0xF,obSubtype(a1)

	4:
		move.w	#0x90,glass_dist(a0)
		bset	#4,obRender(a0)
