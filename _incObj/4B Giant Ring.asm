...
GRing_Main:	/* Routine 0 */
		...
		move.w	#0x2400,obGfx(a0)
		ori.b	#4,obRender(a0)
		move.b	#0x40,obActWid(a0)
		tst.b	obRender(a0)
		bpl.s	GRing_Animate
...
GRing_Okay:
		...
		move.b	#0x52,obColType(a0)
		move.w	#0xC40,(v_gfxbigring).w	/* Signal that Art_BigRing should be loaded ($C40 is the size of Art_BigRing) */
