...
BGHZ_ShipMove:
		...
		addq.b	#2,ob2ndRout(a0)
		move.w	#0x3F,0x3C(a0)
		move.w	#0x100,obVelX(a0) /* move the ship sideways */
		cmpi.w	#0x2A00,0x30(a0)
		bne.s	BGHZ_Reverse
		move.w	#0x7F,0x3C(a0)
		move.w	#0x40,obVelX(a0)
