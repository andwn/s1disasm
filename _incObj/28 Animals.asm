...
Anml_Variables:	dc.w 0xFE00, 0xFC00
		dc.l Map_Animal1
		dc.w 0xFE00, 0xFD00	/* horizontal speed, vertical speed */
...
Anml_EndSpeed:	dc.w 0xFBC0, 0xFC00, 0xFBC0, 0xFC00, 0xFBC0,	0xFC00, 0xFD00, 0xFC00
		dc.w 0xFD00, 0xFC00, 0xFE80, 0xFD00, 0xFE80,	0xFD00, 0xFEC0, 0xFE80
		dc.w 0xFE40, 0xFD00, 0xFE00, 0xFD00, 0xFD80,	0xFC80
...
Anml_EndVram:	dc.w 0x5A5, 0x5A5, 0x5A5, 0x553, 0x553, 0x573, 0x573, 0x585, 0x593
		dc.w 0x565, 0x5B3
# ===========================================================================
...
Anml_Ending:	/* Routine 0 */
		...
		move.w	(a1,d0.w),0x32(a0) /* load horizontal speed */
		move.w	(a1,d0.w),obVelX(a0)
		move.w	2(a1,d0.w),0x34(a0) /* load vertical speed */
...
Anml_FromEnemy:
		...
		adda.w	d0,a1
		move.w	(a1)+,0x32(a0)	/* load horizontal speed */
		move.w	(a1)+,0x34(a0)	/* load vertical	speed */
		move.l	(a1)+,obMap(a0)	/* load mappings */
		move.w	#0x580,obGfx(a0)	/* VRAM setting for 1st animal */
		btst	#0,0x30(a0)	/* is 1st animal	used? */
		beq.s	loc_90C0	/* if yes, branch */
		move.w	#0x592,obGfx(a0)	/* VRAM setting for 2nd animal */
...
loc_912A:
		...
		bpl.s	loc_9180
		add.w	d1,obY(a0)
		move.w	0x32(a0),obVelX(a0)
		move.w	0x34(a0),obVelY(a0)
		move.b	#1,obFrame(a0)
		move.b	0x30(a0),d0
		add.b	d0,d0
		addq.b	#4,d0
