...
FFloor_MakeBlock:
		...
		move.w	#0x5D0,obY(a1)
		addi.w	#0x20,d5		/* add $20 for next X position */
...
FFloor_ChkBreak:/* Routine 2 */
		cmpi.w	#0x474F,obSubtype(a0) /* is object set to disintegrate? */
...
loc_19C36:	/* Routine 4 */
		subi.b	#0xE,obTimeFrame(a0)
		bcc.s	FFloor_Solid2
		moveq	#-1,d0
		move.b	obFrame(a0),d0
		ext.w	d0
		add.w	d0,d0
		move.w	0x30(a0,d0.w),d0
		movea.l	d0,a1
		move.w	#0x474F,obSubtype(a1)
		addq.b	#1,obFrame(a0)
		cmpi.b	#8,obFrame(a0)
		beq.s	loc_19C62
