...
Obj7B_Main:	/* Routine 0 */
		...
		movea.l	0x3C(a0),a1
		move.w	obX(a1),0x30(a0)
		move.w	obY(a1),0x34(a0)
		bset	#0,obStatus(a0)
		move.w	obX(a0),d0
		cmp.w	obX(a1),d0
		bgt.s	loc_18D68
...
loc_18E7A:
		cmpi.w	#0x78,obSubtype(a0)
		bne.s	loc_18E88
		move.b	#5,obDelayAni(a0)

loc_18E88:
		cmpi.w	#0x3C,obSubtype(a0)
		bne.s	loc_18E96
...
loc_19008:
		...
		bra.w	loc_18E7A
# ===========================================================================
word_19018:	dc.w -8, -0x1C, -0x2F, -0x1C, -8
		.align 2
byte_19022:	dc.b 0xE8, 0x30, 0xE8, 0x30
		.align 2
byte_19026:	dc.b 8,	0xF0, 8,	0xF0
		.align 2
# ===========================================================================
...
Obj7B_Explode:	/* Routine 8 */
		...
		clr.b	obRoutine(a0)
		cmpi.w	#0x20,obSubtype(a0)
		beq.s	Obj7B_MakeFrag
		rts	
# ===========================================================================

Obj7B_MakeFrag:
		move.w	0x34(a0),obY(a0)
		moveq	#3,d1
...
loc_1909A:
		...
		rts	
# ===========================================================================
Obj7B_FragSpeed:dc.w -0x100, -0x340	/* horizontal, vertical */
		dc.w -0xA0, -0x240
		dc.w 0x100, -0x340
		dc.w 0xA0, -0x240
# ===========================================================================
