...
.equ eson_time, 0x30	/* time to wait between events */
# ===========================================================================

ESon_Main:	/* Routine 0 */
		cmpi.b	#6,(v_emeralds).w /* do you have all 6 emeralds? */
		beq.s	ESon_Main2	/* if yes, branch */
		addi.b	#0x10,ob2ndRout(a0) /* else, skip emerald sequence */
...
#		 Routine 2
		...
		addq.b	#2,ob2ndRout(a0)
		move.w	#1,obAnim(a0)
		move.b	#id_EndChaos,(v_objspace+0x400).w /* load chaos emeralds objects */
...
Obj87_LookUp:	/* Routine 6 */
		cmpi.w	#0x2000,((v_objspace&0xFFFFFF)+0x400+0x3C).l
		bne.s	locret_5480
...
Obj87_MakeLogo:	/* Routine $C */
		...
		move.b	#2,obAnim(a0)
		move.b	#id_EndSTH,(v_objspace+0x400).w /* load "SONIC THE HEDGEHOG" object */
