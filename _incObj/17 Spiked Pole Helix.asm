...
.equ hel_frame, 0x3E		/* start frame (different for each spike) */
...
Hel_Build:
		...
		addq.b	#1,d6
		andi.b	#7,d6
		addi.w	#0x10,d3		/* skip to next spike */
		addq.b	#1,obSubtype(a0)
...
Hel_RotateSpikes:
		...
		bne.s	locret_7DA6
		move.b	#0x84,obColType(a0) /* make object harmful */
