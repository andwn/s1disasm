...
.equ stair_origX, 0x30		/* original x-axis position */
.equ stair_origY, 0x32		/* original y-axis position */

.equ stair_parent, 0x3C		/* address of parent object (4 bytes) */
# ===========================================================================
...
2:
		...
		add.b	d4,d3
		dbf d1,3b	/* repeat sequence 3 times */
