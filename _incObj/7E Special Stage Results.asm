...
.equ ssr_mainX, 0x30		/* position for card to display on */
# ===========================================================================
...
SSR_Main:
	...
	SSR_Loop:
		...
		move.w	#0x18,obX(a0)
		move.w	#0x118,ssr_mainX(a0) /* change position of text */
...
loc_C86C:
		...
		move.b	#id_SSRChaos,(v_objspace+0x800).w /* load chaos emerald object */
...
SSR_Continue:	/* Routine $E */
		move.b	#4,(v_objspace+0x6C0+obFrame).w
		move.b	#0x14,(v_objspace+0x6C0+obRoutine).w
...
SSR_Display2:
		bra.w	DisplaySprite
# ===========================================================================
SSR_Config:	dc.w 0x20, 0x120,	0xC4	/* start	x-pos, main x-pos, y-pos */
		dc.b 2,	0		/* rountine number, frame number */
		dc.w 0x320, 0x120, 0x118
		dc.b 2,	1
		dc.w 0x360, 0x120, 0x128
		dc.b 2,	2
		dc.w 0x1EC, 0x11C, 0xC4
		dc.b 2,	3
		dc.w 0x3A0, 0x120, 0x138
		dc.b 2,	6
