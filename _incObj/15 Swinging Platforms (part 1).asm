...
.equ swing_origX, 0x3A		/* original x-axis position */
.equ swing_origY, 0x38		/* original y-axis position */
# ===========================================================================

Swing_Main:	/* Routine 0 */
		addq.b	#2,obRoutine(a0)
		move.l	#Map_Swing_GHZ,obMap(a0) /* GHZ and MZ specific code */
		move.w	#0x4380,obGfx(a0)
		...
		move.w	#0x43DC,obGfx(a0)
		move.b	#0x20,obActWid(a0)
		move.b	#0x10,obHeight(a0)
		move.b	#0x99,obColType(a0)
	...
	1:
		...
		move.w	#0x391,obGfx(a0)
		move.b	#0x18,obActWid(a0)
		move.b	#0x18,obHeight(a0)
		move.b	#0x86,obColType(a0)
		move.b	#0xC,obRoutine(a0) /* goto Swing_Action next */
...
3:
	...
	5:
		dbf d1,3b /* repeat d1 times (chain length) */
	...
	4:
		...
		andi.w	#0x7F,d5
		move.b	d5,(a2)+
		move.w	#0x4080,obAngle(a0)
		move.w	#-0x200,0x3E(a0)
		move.w	(sp)+,d1
		btst	#4,d1		/* is object type $1X ? */
		beq.s	6f	/* if not, branch */
		move.l	#Map_GBall,obMap(a0) /* use GHZ ball mappings */
		move.w	#0x43AA,obGfx(a0)
		move.b	#1,obFrame(a0)
		move.b	#2,obPriority(a0)
		move.b	#0x81,obColType(a0) /* make object hurt when touched */
