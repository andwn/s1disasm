...
.equ spring_pow, 0x30			/* power of current spring */

Spring_Powers:	dc.w -0x1000		/* power	of red spring */
		dc.w -0xA00		/* power	of yellow spring */
# ===========================================================================

Spring_Main:	/* Routine 0 */
		addq.b	#2,obRoutine(a0)
		move.l	#Map_Spring,obMap(a0)
		move.w	#0x523,obGfx(a0)
		ori.b	#4,obRender(a0)
	...
	Spring_NotLR:
		...
		move.b	#0xE,obRoutine(a0) /* use "Spring_Dwn" routine */
		bset	#1,obStatus(a0)
