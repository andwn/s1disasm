...
.equ eegg_time, 0x30		/* time between juggle motions */
# ===========================================================================

EEgg_Main:	/* Routine 0 */
		addq.b	#2,obRoutine(a0)
		move.w	#0x120,obX(a0)
		move.w	#0xF4,obScreenY(a0)
		...
		move.b	#id_CreditsText,(v_objspace+0xC0).w /* load credits object */
		move.w	#9,(v_creditsnum).w /* use "TRY AGAIN" text */
		move.b	#id_TryChaos,(v_objspace+0x800).w /* load emeralds object on "TRY AGAIN" screen */
...
EEgg_Juggle:	/* Routine 4 */
	...
	1:
		lea	(v_objspace+0x800).w,a1 /* get RAM address for emeralds */
		moveq	#5,d1
