...
.equ CStom_switch, 0x3A			/* switch number for the current stomper */
...
CStom_SetSize:
		...
		bra.s	loc_B798
# ===========================================================================
CStom_Var2:	dc.b 0x38, 0		/* width, frame number */
		dc.b 0x30, 9
		dc.b 0x10, 0xA
# ===========================================================================
...
loc_B8A8:
		...
		beq.s	CStom_Restart
		move.w	obVelY(a0),d0
		addi.w	#0x70,obVelY(a0)	/* make object fall */
		add.w	d0,0x32(a0)
		cmp.w	0x32(a0),d1
		bhi.s	CStom_Restart
		move.w	d1,0x32(a0)
