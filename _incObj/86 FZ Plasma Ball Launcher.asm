...
Obj86_Loop:
		...
		move.w	#0x2300,obGfx(a1)
		move.l	#Map_Plasma,obMap(a1)
		move.b	#0xC,obHeight(a1)
		move.b	#0xC,obWidth(a1)
		move.b	#0,obColType(a1)
		move.b	#3,obPriority(a1)
		move.w	#0x3E,obSubtype(a1)
