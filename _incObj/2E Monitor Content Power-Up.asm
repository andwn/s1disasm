...
Pow_Main:	/* Routine 0 */
		...
		move.w	#0x680,obGfx(a0)
		move.b	#0x24,obRender(a0)
		move.b	#3,obPriority(a0)
		move.b	#8,obActWid(a0)
		move.w	#-0x300,obVelY(a0)
		moveq	#0,d0
...
Pow_Move:	/* Routine 2 */
		...
		bsr.w	SpeedToPos
		addi.w	#0x18,obVelY(a0)	/* reduce object	speed */
		rts	
# ===========================================================================
...
Pow_ChkShoes:
		...
		move.w	#0x4B0,(v_player+0x34).w	/* time limit for the power-up */
		move.w	#0xC00,(v_sonspeedmax).w /* change Sonic's top speed */
		move.w	#0x18,(v_sonspeedacc).w	/* change Sonic's acceleration */
		move.w	#0x80,(v_sonspeeddec).w	/* change Sonic's deceleration */
...
Pow_ChkShield:
		...
		move.b	#id_ShieldItem,(v_objspace+0x180).w /* load shield object ($38) */
...
Pow_ChkInvinc:
		...
		move.w	#0x4B0,(v_player+0x32).w /* time limit for the power-up */
		move.b	#id_ShieldItem,(v_objspace+0x200).w /* load stars object ($3801) */
		move.b	#1,(v_objspace+0x200+obAnim).w
		move.b	#id_ShieldItem,(v_objspace+0x240).w /* load stars object ($3802) */
		move.b	#2,(v_objspace+0x240+obAnim).w
		move.b	#id_ShieldItem,(v_objspace+0x280).w /* load stars object ($3803) */
		move.b	#3,(v_objspace+0x280+obAnim).w
		move.b	#id_ShieldItem,(v_objspace+0x2C0).w /* load stars object ($3804) */
		move.b	#4,(v_objspace+0x2C0+obAnim).w
