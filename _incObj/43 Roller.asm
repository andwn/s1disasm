...
Roll_RollChk:
		...
		move.b	#2,obAnim(a0)
		move.w	#0x700,obVelX(a0) /* move Roller horizontally */
		move.b	#0x8E,obColType(a0) /* make Roller invincible */
...
Roll_RollNoChk:
		...
		bpl.s	locret_E0F6
		move.b	#1,obAnim(a0)
		move.w	#0x700,obVelX(a0)
		move.b	#0x8E,obColType(a0)
...
Roll_Jump:
		...
		bset	#0,0x32(a0)
		beq.s	locret_E12E
		move.w	#-0x600,obVelY(a0)	/* move Roller vertically */
...
Roll_Stop:
		...
		bcc.s	locret_E188
		move.b	#0,obAnim(a0)
		move.b	#0xE,obColType(a0)
		clr.w	obVelX(a0)
		move.w	#120,0x30(a0)	/* set waiting time to 2	seconds */
