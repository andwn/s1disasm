...
CSon_Main:	/* Routine 0 */
		...
		move.w	#0x400,obVelY(a0) /* make Sonic fall from above */

CSon_ChkLand:	/* Routine 2 */
		cmpi.w	#0x1A0,obY(a0)	/* has Sonic landed yet? */
...
CSon_Run:	/* Routine 6 */
		cmpi.w	#0x800,obInertia(a0) /* check Sonic's inertia */
		bne.s	CSon_AddInertia	/* if too low, branch */
		move.w	#0x1000,obVelX(a0) /* move Sonic to the right */
		bra.s	CSon_ShowRun

CSon_AddInertia:
		addi.w	#0x20,obInertia(a0) /* increase inertia */
