...
.equ spintime, 0x30		/* time for signpost to spin */
.equ sparkletime, 0x32		/* time between sparkles */
.equ sparkle_id, 0x34		/* counter to keep track of sparkles */
# ===========================================================================
...
Sign_Touch:	/* Routine 2 */
		...
		sub.w	obX(a0),d0
		bcs.s	1f
		cmpi.w	#0x20,d0		/* is Sonic within $20 pixels of	the signpost? */
...
Sign_Spin:	/* Routine 4 */
	...
	1:
		...
		bpl.s	2f		/* if time remains, branch */
		move.w	#0xB,sparkletime(a0) /* set time between sparkles to $B frames */
		moveq	#0,d0
		move.b	sparkle_id(a0),d0 /* get sparkle id */
		addq.b	#2,sparkle_id(a0) /* increment sparkle counter */
		andi.b	#0xE,sparkle_id(a0)
	...
	2:
		rts	
# ===========================================================================
Sign_SparkPos:	dc.b -0x18,-0x10		/* x-position, y-position */
		dc.b	8,   8
		dc.b -0x10,   0
		dc.b  0x18,  -8
		dc.b	0,  -8
