...
Obj09_ExitStage:
		addi.w	#0x40,(v_ssrotate).w
		cmpi.w	#0x1800,(v_ssrotate).w
		bne.s	loc_1BBF4
		move.b	#id_Level,(v_gamemode).w

loc_1BBF4:
		cmpi.w	#0x3000,(v_ssrotate).w
		blt.s	loc_1BC12
		move.w	#0,(v_ssrotate).w
		move.w	#0x4000,(v_ssangle).w
		addq.b	#2,obRoutine(a0)
		move.w	#0x3C,0x38(a0)
...
Obj09_ChkCont:
		cmpi.b	#0x3A,d4		/* is the item a	ring? */
		bne.s	Obj09_Chk1Up
...
Obj09_Chk1Up:
		cmpi.b	#0x28,d4		/* is the item an extra life? */
		bne.s	Obj09_ChkEmer
		bsr.w	SS_RemoveCollectedItem
		bne.s	Obj09_Get1Up
		move.b	#3,(a2)
...
Obj09_ChkEmer:
		cmpi.b	#0x3B,d4		/* is the item an emerald? */
...
Obj09_ChkGhost:
		cmpi.b	#0x41,d4		/* is the item a	ghost block? */
		bne.s	Obj09_ChkGhostTag
		move.b	#1,0x3A(a0)	/* mark the ghost block as "passed" */

Obj09_ChkGhostTag:
		cmpi.b	#0x4A,d4		/* is the item a	switch for ghost blocks? */
		bne.s	Obj09_NoGhost
		cmpi.b	#1,0x3A(a0)	/* have the ghost blocks	been passed? */
		bne.s	Obj09_NoGhost	/* if not, branch */
		move.b	#2,0x3A(a0)	/* mark the ghost blocks	as "solid" */
...
Obj09_MakeGhostSolid:
		cmpi.b	#2,0x3A(a0)	/* is the ghost marked as "solid"? */
...
Obj09_GhostLoop:
		cmpi.b	#0x41,(a1)	/* is the item a	ghost block? */
		bne.s	Obj09_NoReplace	/* if not, branch */
		move.b	#0x2C,(a1)	/* replace ghost	block with a solid block */
...
Obj09_ChkBumper:
		cmpi.b	#0x25,d0		/* is the item a	bumper? */
		bne.s	Obj09_GOAL
		move.l	0x32(a0),d1
		subi.l	#0xFF0001,d1
		move.w	d1,d2
...
Obj09_GOAL:
		cmpi.b	#0x27,d0		/* is the item a	"GOAL"? */
		bne.s	Obj09_UPblock
...
Obj09_UPblock:
		cmpi.b	#0x29,d0		/* is the item an "UP" block? */
		...
		movea.l	0x32(a0),a1
		subq.l	#1,a1
		move.b	#0x2A,(a1)	/* change item to a "DOWN" block */
...
Obj09_DOWNblock:
		cmpi.b	#0x2A,d0		/* is the item a	"DOWN" block? */
		bne.s	Obj09_Rblock
		tst.b	0x36(a0)
		bne.w	Obj09_NoGlass
		move.b	#0x1E,0x36(a0)
		...
		movea.l	0x32(a0),a1
		subq.l	#1,a1
		move.b	#0x29,(a1)	/* change item to an "UP" block */
...
Obj09_Rblock:
		cmpi.b	#0x2B,d0		/* is the item an "R" block? */
...
Obj09_ChkGlass:
		cmpi.b	#0x2D,d0		/* is the item a	glass block? */
