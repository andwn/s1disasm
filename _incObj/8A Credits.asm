...
Cred_Main:	/* Routine 0 */
		...
		move.w	#0x120,obX(a0)
		move.w	#0xF0,obScreenY(a0)
		move.l	#Map_Cred,obMap(a0)
		move.w	#0x5A0,obGfx(a0)
		...
		move.w	#0xA6,obGfx(a0)
		move.b	#0xA,obFrame(a0)	/* display "SONIC TEAM PRESENTS" */
		...
		bne.s	Cred_Display	/* if not, branch */
		move.w	#cWhite,(v_pal_dry_dup+0x40).w /* 3rd palette, 1st entry = white */
		move.w	#0x880,(v_pal_dry_dup+0x42).w /* 3rd palette, 2nd entry = cyan */
		jmp	(DeleteObject).l
# ===========================================================================
