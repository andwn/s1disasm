...
BGHZ_ShipStart:
		move.w	#0x100,obVelY(a0) /* move ship down */
		bsr.w	BossMove
		cmpi.w	#0x338,0x38(a0)
		bne.s	loc_177E6
...
loc_177E6:
		...
		move.b	#0x20,0x3E(a0)	/* set number of	times for ship to flash */
		sfx	sfx_HitBoss,0,0,0	/* play boss damage sound */

BGHZ_ShipFlash:
		lea	(v_pal_dry+0x22).w,a1 /* load 2nd pallet, 2nd entry */
