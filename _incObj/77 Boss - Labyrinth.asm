...
Obj77_Main:	/* Routine 0 */
		move.w	#0x1E10,obX(a0)
		move.w	#0x5C0,obY(a0)
		move.w	obX(a0),0x30(a0)
...
loc_17F1E:
		...
		move.w	#0x60,obVelX(a0)
		addq.b	#2,ob2ndRout(a0)

loc_17F38:
		bsr.w	BossMove
		move.w	0x38(a0),obY(a0)
		move.w	0x30(a0),obX(a0)
...
loc_17FA0:
		moveq	#-2,d0
		cmpi.w	#0x1E48,0x30(a0)
		bcs.s	loc_17FB6
		move.w	#0x1E48,0x30(a0)
		clr.w	obVelX(a0)
		addq.w	#1,d0

loc_17FB6:
		cmpi.w	#0x500,0x38(a0)
		bgt.s	loc_17FCA
		move.w	#0x500,0x38(a0)
		clr.w	obVelY(a0)
		addq.w	#1,d0

loc_17FCA:
		bne.s	loc_17FDC
		move.w	#0x140,obVelX(a0)
		move.w	#-0x200,obVelY(a0)
		addq.b	#2,ob2ndRout(a0)
...
loc_17FE0:
		moveq	#-2,d0
		cmpi.w	#0x1E70,0x30(a0)
		bcs.s	loc_17FF6
		move.w	#0x1E70,0x30(a0)
		clr.w	obVelX(a0)
		addq.w	#1,d0

loc_17FF6:
		cmpi.w	#0x4C0,0x38(a0)
		bgt.s	loc_1800A
		move.w	#0x4C0,0x38(a0)
		clr.w	obVelY(a0)
		addq.w	#1,d0
...
loc_1801E:
		cmpi.w	#0x100,0x38(a0)
		bgt.s	loc_1804E
		move.w	#0x100,0x38(a0)
		move.w	#0x140,obVelX(a0)
		move.w	#-0x80,obVelY(a0)
		tst.b	0x3D(a0)
		beq.s	loc_18046
		asl	obVelX(a0)
		asl	obVelY(a0)
...
loc_180BC:
		moveq	#-2,d0
		cmpi.w	#0x1F4C,0x30(a0)
		bcs.s	loc_180D2
		move.w	#0x1F4C,0x30(a0)
		clr.w	obVelX(a0)
		addq.w	#1,d0
