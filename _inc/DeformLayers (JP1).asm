...
loc_62F6:
		move.w	d0,d4
		move.w	d0,(0xFFFFF618).w
		move.w	(v_screenposx).w,d0
		cmpi.b	#id_Title,(0xFFFFF600).w
		bne.s	loc_630A
		moveq	#0,d0
loc_630A:
		neg.w	d0
...
Deform_LZ:
		...
		move.b	(0xFFFFF7D8).w,d2
		move.b	d2,d3
		addi.w	#0x80,(0xFFFFF7D8).w
...
Lz_Scroll_Data:
		dc.b 0x01,0x01,0x02,0x02,0x03,0x03,0x03,0x03,0x02,0x02,0x01,0x01,0x00,0x00,0x00,0x00
		...
		dc.b 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
		dc.b 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
		dc.b 0xFF,0xFF,0xFE,0xFE,0xFD,0xFD,0xFD,0xFD,0xFE,0xFE,0xFF,0xFF,0x00,0x00,0x00,0x00
		dc.b 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
		dc.b 0x01,0x01,0x02,0x02,0x03,0x03,0x03,0x03,0x02,0x02,0x01,0x01,0x00,0x00,0x00,0x00
		dc.b 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
		dc.b 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
...
ScrollHoriz:
		...
		move.w	(v_screenposx).w,d0
		andi.w	#0x10,d0
		move.b	(0xFFFFF74A).w,d1
		eor.b	d1,d0
		bne.s	locret_65B0
		eori.b	#0x10,(0xFFFFF74A).w
		move.w	(v_screenposx).w,d0
...
loc_66CC:
		...
		bgt.s	loc_66F0
		andi.w	#0x7FF,d1
		andi.w	#0x7FF,(v_player+obY).w
		andi.w	#0x7FF,(v_screenposy).w
		andi.w	#0x3FF,(v_bgscreenposy).w
		bra.s	loc_6724
# ===========================================================================
...
loc_6724:
		...
		ror.l	#8,d3
		move.w	d3,(0xFFFFF73C).w
		move.l	d1,(v_screenposy).w
		move.w	(v_screenposy).w,d0
		andi.w	#0x10,d0
		move.b	(0xFFFFF74B).w,d1
		eor.b	d1,d0
		bne.s	locret_6766
		eori.b	#0x10,(0xFFFFF74B).w
		move.w	(v_screenposy).w,d0
		sub.w	d4,d0
		bpl.s	loc_6760
...
ScrollBlock1:
		...
		swap.w	d1
		andi.w	#0x10,d1
		move.b	(0xFFFFF74C).w,d3
		eor.b	d3,d1
		bne.s	loc_6AF8
		eori.b	#0x10,(0xFFFFF74C).w
		sub.l	d2,d0
		bpl.s	loc_6AF2
...
loc_6AF8:
		...
		swap.w	d1
		andi.w	#0x10,d1
		move.b	(0xFFFFF74D).w,d2
		eor.b	d2,d1
		bne.s	loc_6B2C
		eori.b	#0x10,(0xFFFFF74D).w
		sub.l	d3,d0
		bpl.s	loc_6B26
...
ScrollBlock4:
		...
		swap.w	d1
		andi.w	#0x10,d1
		move.b	(0xFFFFF74E).w,d3
		eor.b	d3,d1
		bne.s	Exit_Scroll_Block4
		eori.b	#0x10,(0xFFFFF74E).w
		sub.l	d2,d0
		bpl.s	loc_6BF4
...
ScrollBlock5:
		...
		swap.w	d1
		andi.w	#0x10,d1
		move.b	(0xFFFFF750).w,d3
		eor.b	d3,d1
		bne.s	loc_6C2E
		eori.b	#0x10,(0xFFFFF750).w
		sub.l	d2,d0
		bpl.s	loc_6C28
		bset	d6,(0xFFFFF75A).w
		bra.s	loc_6C2E
loc_6C28:
		addq.b	#1,d6
		bset	d6,(0xFFFFF75A).w
