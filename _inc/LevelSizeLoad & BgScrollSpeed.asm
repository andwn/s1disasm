...
LevelSizeLoad:
		moveq	#0,d0
		move.b	d0,(0xFFFFF740).w
		move.b	d0,(0xFFFFF741).w
		move.b	d0,(0xFFFFF746).w
		move.b	d0,(0xFFFFF748).w
...
LevelSizeArray:	.incbin	"misc/Level Size Array.bin"
		.align 2
#		zonewarning LevelSizeArray,0x30
...
# 		loop	loop	tunnel	tunnel
	...
	dc.b	0xB5,	0x7F,	0x1F,	0x20	/* Green Hill */
	dc.b	0x7F,	0x7F,	0x7F,	0x7F	/* Labyrinth */
	dc.b	0x7F,	0x7F,	0x7F,	0x7F	/* Marble */
	dc.b	0xAA,	0xB4,	0x7F,	0x7F	/* Star Light */
	dc.b	0x7F,	0x7F,	0x7F,	0x7F	/* Spring Yard */
	dc.b	0x7F,	0x7F,	0x7F,	0x7F	/* Scrap Brain */
	dc.b	0x7F,	0x7F,	0x7F,	0x7F	/* Ending (Green Hill) */
...
# ===========================================================================
dword_61B4:	dc.l 0x700100, 0x1000100
		dc.l 0x8000100, 0x1000000
		dc.l 0x8000100, 0x1000000
		dc.l 0x8000100, 0x1000000
		dc.l 0x8000100, 0x1000000
		dc.l 0x8000100, 0x1000000
		dc.l 0x700100, 0x1000100
...
BgScroll_End:
		move.w	#0x1E,(v_bgscreenposy).w
		move.w	#0x1E,(v_bg2screenposy).w
		rts	
# ===========================================================================
		move.w	#0xA8,(v_bgscreenposx).w
		move.w	#0x1E,(v_bgscreenposy).w
		move.w	#-0x40,(v_bg2screenposx).w
		move.w	#0x1E,(v_bg2screenposy).w
		rts
