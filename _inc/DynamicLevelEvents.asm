...
DLE_GHZ1:
		move.w	#0x300,(v_limitbtm1).w /* set lower y-boundary */
		cmpi.w	#0x1780,(v_screenposx).w /* has the camera reached $1780 on x-axis? */
		bcs.s	locret_6E08	/* if not, branch */
		move.w	#0x400,(v_limitbtm1).w /* set lower y-boundary */
...
DLE_GHZ2:
		move.w	#0x300,(v_limitbtm1).w
		cmpi.w	#0xED0,(v_screenposx).w
		bcs.s	locret_6E3A
		move.w	#0x200,(v_limitbtm1).w
		cmpi.w	#0x1600,(v_screenposx).w
		bcs.s	locret_6E3A
		move.w	#0x400,(v_limitbtm1).w
		cmpi.w	#0x1D60,(v_screenposx).w
		bcs.s	locret_6E3A
		move.w	#0x300,(v_limitbtm1).w
...
DLE_GHZ3main:
		move.w	#0x300,(v_limitbtm1).w
		cmpi.w	#0x380,(v_screenposx).w
		bcs.s	locret_6E96
		move.w	#0x310,(v_limitbtm1).w
		cmpi.w	#0x960,(v_screenposx).w
		bcs.s	locret_6E96
		cmpi.w	#0x280,(v_screenposy).w
		bcs.s	loc_6E98
		move.w	#0x400,(v_limitbtm1).w
		cmpi.w	#0x1380,(v_screenposx).w
		bcc.s	loc_6E8E
		move.w	#0x4C0,(v_limitbtm1).w
		move.w	#0x4C0,(v_limitbtm2).w

loc_6E8E:
		cmpi.w	#0x1700,(v_screenposx).w
		bcc.s	loc_6E98
...
DLE_LZ3:
		tst.b	(f_switch+0xF).w	/* has switch $F	been pressed? */
		beq.s	loc_6F28	/* if not, branch */
		lea	(v_lvllayout+0x106).w,a1
		cmpi.b	#7,(a1)
		beq.s	loc_6F28
...
loc_6F28:
		...
		bne.s	locret_6F64
		cmpi.w	#0x1CA0,(v_screenposx).w
		bcs.s	locret_6F62
		cmpi.w	#0x600,(v_screenposy).w
		bcc.s	locret_6F62
		bsr.w	FindFreeObj
		bne.s	loc_6F4A
...
DLE_SBZ3:
		cmpi.w	#0xD00,(v_screenposx).w
		bcs.s	locret_6F8C
		cmpi.w	#0x18,(v_player+obY).w /* has Sonic reached the top of the level? */
...
loc_6FBA:
		move.w	#0x1D0,(v_limitbtm1).w
		cmpi.w	#0x700,(v_screenposx).w
		bcs.s	locret_6FE8
		move.w	#0x220,(v_limitbtm1).w
		cmpi.w	#0xD00,(v_screenposx).w
		bcs.s	locret_6FE8
		move.w	#0x340,(v_limitbtm1).w
		cmpi.w	#0x340,(v_screenposy).w
		bcs.s	locret_6FE8
		addq.b	#2,(v_dle_routine).w
...
loc_6FF8:
		...
		cmpi.w	#0xE00,(v_screenposx).w
		bcc.s	locret_702C
		move.w	#0x340,(v_limittop2).w
		move.w	#0x340,(v_limitbtm1).w
		cmpi.w	#0xA90,(v_screenposx).w
		bcc.s	locret_702C
		move.w	#0x500,(v_limitbtm1).w
		cmpi.w	#0x370,(v_screenposy).w
		bcs.s	locret_702C
		addq.b	#2,(v_dle_routine).w
...
loc_703C:
		cmpi.w	#0x500,(v_screenposy).w
		bcs.s	locret_704E
		.if Revision==0
		.else
			cmpi.w	#0xB80,(v_screenposx).w
			bcs.s	locret_704E
		.endc
		move.w	#0x500,(v_limittop2).w
		addq.b	#2,(v_dle_routine).w
...
loc_7050:
		...
		.else
			cmpi.w	#0xB80,(v_screenposx).w
			bcc.s	locj_76B8
			cmpi.w	#0x340,(v_limittop2).w
			beq.s	locret_7072
			subq.w	#2,(v_limittop2).w
			rts
	locj_76B8:
			cmpi.w	#0x500,(v_limittop2).w
			beq.s	locj_76CE
			cmpi.w	#0x500,(v_screenposy).w
			bcs.s	locret_7072
			move.w	#0x500,(v_limittop2).w
	locj_76CE:
		...
		cmpi.w	#0xE70,(v_screenposx).w
		bcs.s	locret_7072
		move.w	#0,(v_limittop2).w
		move.w	#0x500,(v_limitbtm1).w
		cmpi.w	#0x1430,(v_screenposx).w
		bcs.s	locret_7072
		move.w	#0x210,(v_limitbtm1).w
...
DLE_MZ3boss:
		move.w	#0x720,(v_limitbtm1).w
		cmpi.w	#0x1560,(v_screenposx).w
		bcs.s	locret_70E8
		move.w	#0x210,(v_limitbtm1).w
		cmpi.w	#0x17F0,(v_screenposx).w
		bcs.s	locret_70E8
		bsr.w	FindFreeObj
		bne.s	loc_70D0
...
DLE_SYZ2:
		move.w	#0x520,(v_limitbtm1).w
		cmpi.w	#0x25A0,(v_screenposx).w
		bcs.s	locret_71A2
		move.w	#0x420,(v_limitbtm1).w
		cmpi.w	#0x4D0,(v_player+obY).w
		bcs.s	locret_71A2
		move.w	#0x520,(v_limitbtm1).w
...
DLE_SYZ3boss:
		cmpi.w	#0x2C00,(v_screenposx).w
		bcs.s	locret_7200
		move.w	#0x4CC,(v_limitbtm1).w
		bsr.w	FindFreeObj
		bne.s	loc_71EC
...
DLE_SBZ1:
		move.w	#0x720,(v_limitbtm1).w
		cmpi.w	#0x1880,(v_screenposx).w
		bcs.s	locret_7242
		move.w	#0x620,(v_limitbtm1).w
		cmpi.w	#0x2000,(v_screenposx).w
		bcs.s	locret_7242
		move.w	#0x2A0,(v_limitbtm1).w
...
DLE_SBZ2main:
		move.w	#0x800,(v_limitbtm1).w
		cmpi.w	#0x1800,(v_screenposx).w
		bcs.s	locret_727A
		move.w	#0x510,(v_limitbtm1).w
		cmpi.w	#0x1E00,(v_screenposx).w
		bcs.s	locret_727A
		addq.b	#2,(v_dle_routine).w
